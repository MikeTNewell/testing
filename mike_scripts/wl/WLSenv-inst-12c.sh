...
#                     Default to 12.1.2 setup.
#                     Switched patching variables.
# 2014/03/25 cgwong - [v1.2.3] Updated some variables. 
# 2014/04/17 cgwong: [v1.2.4] Removed unneeded variables and updated others. 
# 2014/05/07 cgwong: [v1.2.4] Removed unneeded variables and updated others.
######################################################
