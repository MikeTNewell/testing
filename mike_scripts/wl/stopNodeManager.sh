...
# 2013/01/17 cgwong - [v1.0.0] Updated comments
...
${WL_HOME}/common/bin/wlst.sh -loadProperties ${SCRIPT_PATH}/WLSenv-run.properties ${SCRIPT_PATH}/stopNodeManager.py
