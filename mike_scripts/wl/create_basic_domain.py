...
readTemplate("/data/app/oracle/middleware/wlserver/common/templates/wls/wls.jar")
...
writeDomain('/data/app/oracle/middleware/user_projects/domains/basicWLSDomain')
closeTemplate()
